...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'web:inline-flex h-10 native:h-12 items-center justify-center rounded-lg bg-blue-50 p-1 native:px-1.5',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <TextClassContext.Provider
      value={cn(
        'text-sm native:text-base font-semibold text-zinc-600 web:transition-all',
