...
import { changePasswordWithoutUserId } from '@/server/auth/change-password-without-userId'
...
export default function ChangePassword() {
  ...
  const changePasswordMutation = useMutation({
    mutationFn: changePasswordWithoutUserId,
    onSuccess: data => {
      setMessage(null)
      router.back()
    },
      ...
      <View className="flex-1 items-center justify-center bg-gray-50">
        <Card className="w-[80%] gap-3">
          <CardHeader className="items-center">
            <CardTitle className="text-primary font-semibold mt-5">
              Alterar Senha
            </CardTitle>
          </CardHeader>
